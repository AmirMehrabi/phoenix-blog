<html>
    <head>
        ...
        <meta charset="utf-8" />
        <title>هبیتا | {{ $post->title }}</title>
        <meta name="title" content="هبیتا" />
        <link
            rel="preload"
    ...
    <body class="rtl">
        <nav class="nav flex flex-wrap items-center justify-between px-4">
          ...
          <section class="text-gray-600 body-font overflow-hidden">
            <div class="container px-5 py-24 mx-auto w-full md:w-3/4">
            <article class="prose">
            <h1 class="font-bold text-black text-3xl border-b mb-4">{{ $post->title }}</h1>
