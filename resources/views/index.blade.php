...
{{-- <section class="text-gray-600 body-font rtl">
  <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      ...
      <div class="flex justify-center">
        <a href="#blog" class="inline-flex text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded text-lg">Read</a>
        <a href="about.html" class="ml-4 inline-flex text-gray-700 bg-gray-100 border-0 py-2 px-6 focus:outline-none hover:bg-gray-200 rounded text-lg">About me</a>
      </div>
    </div>
...
<section id="blog" class="text-gray-600 body-font overflow-hidden rtl">
  <div class="container px-5 py-24 mx-auto">
    <div class="-my-8 divide-y-2 divide-gray-100">
        @foreach ($posts as $post)
        <div class="py-8 flex flex-wrap md:flex-nowrap">
            <div>
              <p class="text-sm font-medium text-gray-900 title-font mb-2">{{ $post->created_at->diffForHumans() }}</p>
              <h2 class="text-2xl font-medium text-gray-900 title-font mb-2">{{ $post->title }}</h2>
              <p class="leading-relaxed">{{ \Illuminate\Support\Str::words(strip_tags($post->body), 20) }}</p>
              <a href="{{ $post->url }}" class="text-blue-500 inline-flex items-center mt-4">بیشتر بخوانید &rarr;
              </a>
            </div>
          </div>
        @endforeach
...
<section><div class="mx-auto container">
</div></section>
